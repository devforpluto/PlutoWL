...
create_command(
    ...
    try {
      ...
      await interaction.followUp({
        embeds: [
          success_embed.setDescription(
            `**Successfully disabled ${member.user.toString()}'s key || ${Formatters.bold(
      ...
      member.user
        .send({
          embeds: [
            success_embed
              .setDescription(Formatters.bold("Your key has been disabled"))
              .setAuthor({
  ...
  },
  {
    ...
    description: "Disables the provided user's key",
